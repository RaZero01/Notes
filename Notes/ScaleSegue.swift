...
//  Notes
//
//  Created by Konstantin Razinkov on 23/10/2018.
...
class UnwindScaleSegue: UIStoryboardSegue {
    ...
    func scale(){
       ...
       fromViewController.view.superview?.insertSubview(toViewController.view, at: 0)
        ...
        UIView.animate(withDuration: 0.5, delay: 0, options: .curveEaseInOut, animations: {fromViewController.view.transform = CGAffineTransform(scaleX: 0.05, y: 0.05)}, completion: { success in
